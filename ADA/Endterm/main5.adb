...
procedure Main5 is
   ...
   protected Manager is
      procedure AddPoints(p : Natural);
      procedure AddPlayers;

      function getPoins return Natural;
      function getPlayers return Natural;
      private
      players : Natural := 0;
      points : Natural := 0;
   end Manager;
   ...
   protected body Manager is
      procedure AddPoints(p : Natural) is
      begin
         points := p + points;
      end Addpoints;

      procedure AddPlayers is

      begin
         players := players + 1;
         end AddPlayers;

      function getPoins return Natural is
      begin
         return points;
      end getPoins;

      function getPlayers return Natural is
...
begin
 ...
 delay 20.0;
   Printer.Print("Manager: " & Manager.getPlayers'image & " players got in");
   Printer.Print("Manager: total score " & Manager.getPoins'image);
