...
updateTree (Node x le ri) n = Node (x rem n) (updateTree le n) (updateTree ri n)
...
HungarianBasic = {id="Basic1",uni=Deb,credits=2}

instance == Course
where
	(==) a b = a.id == b.id && abs (a.credits - b.credits) < 2
