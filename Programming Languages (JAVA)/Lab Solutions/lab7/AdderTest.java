...
public class AdderTest {
    ...
    public void add_isSane() {
        ...
        assertNotEquals(Adder.add("1","2"), Adder.add("1", "3"));
    }

    @Test 
    public void add_hasPropersties() {
        // commutative
        assertEquals(Adder.add("250", "300"), Adder.add("300", "250"));
    ...
    assertEquals(2.526 + 4.995, result2,EPSILON);
  }

  @Test
  public void add_trimString() { //fail
    assertEquals(String.valueOf(21+23) , Adder.add(" 21 ", "  23 "));
  }
